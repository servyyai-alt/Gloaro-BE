 ...
 */
router.post("/", authorize(ROLES.VENDOR), uploadMultiple("gallery", "services"), serviceController.createService);
 ...
 */
router.patch("/:id/approve", authorize(ROLES.ADMIN, ROLES.SUPERADMIN), serviceController.approveService);
